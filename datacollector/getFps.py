...
class SurfaceStatsCollector(object):
  ...
  """
    ...
    """
        ...
        # def _GetSurfaceStatsLegacy(self):  # adb shell service call SurfaceFlinger 1013
...
# @ test code
# resultList = []
# getfps = SurfaceStatsCollector()
# getfps.Start()
#
# for i in range(1):
#     sleep(0.3)
#     results = getfps.SampleResults()
#     if not results:
#         pass
#     else:
#         for i in range(0, len(results)):
#             print results[i].name
#             print results[i].unit
#             print results[i].value
#             print '\n'
#         resultList.append(int(results[1].value))
# print resultList
#
# getfps.Stop()
